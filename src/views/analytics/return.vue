      ...
      <el-col :span="24">
        <div class="grid-content bg-purple">
          <el-card v-loading="loading" class="box-card">
            <template #header>
              {{ t('订单销售金额对比图') }}
              <el-radio-group size="small" style="float: right;">
                <el-radio-button :label="t('7天')" @click.prevent="getSaleOrderAmountFun(7)" />
                <el-radio-button :label="t('30天')" @click.prevent="getSaleOrderAmountFun(30)" />
                <el-radio-button :label="t('3个月')" @click.prevent="getSaleOrderAmountFun(90)" />
                <el-radio-button :label="t('半年')" @click.prevent="getSaleOrderAmountFun(180)" />
              </el-radio-group>
            </template>
            <ms-chart
